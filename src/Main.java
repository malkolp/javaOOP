...
public class Main 
{
    ...
    public static void main(String[] args)
    {
        ...
        profiles.add(new Profile("Laila Khusniyah", "laila22@gmail.com"));
        profiles.add(new Profile("Wildan Agil", "wildan10@gmail.com"));
        
        profiles.add(new Profile("Farida Ratna", "farida11@gmail.com"));
        profiles.add(new Profile("Sunaryo", "naryo08@gmail.com"));
